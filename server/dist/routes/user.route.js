...
router.post("/signup", (0, validate_1.validate)(user_validation_1.userValidationSchema), user_controller_1.registerUser);
router.post("/signin", (0, validate_1.validate)(user_validation_1.userLoginValidationSchema), user_controller_1.signIn);
